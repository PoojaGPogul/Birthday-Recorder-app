...
public class ViewSearchData  extends JFrame
{
	ResultSet rs;
	...
	public ViewSearchData(int i,String data) throws Exception
	{
		...
		try
			...
			if(i==0)
		   	...
		   	rs=st1.executeQuery("select * from birthday where "+str+" like '"+data+"%';");
		   	rs.first();
		  ...
		  catch(Exception e)
		  {
			...
			ViewSearchData.this.setVisible(false);
